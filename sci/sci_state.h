...
extern uint8_t  cc_spr[0x4000];      /* S.C.I. spriteram, two 0x1000-byte frame pages */
...
extern uint8_t cc_gfx_spr2[];  /* compatibility blob; S.C.I. uses cc_gfx_spr */
extern uint8_t cc_gfx_smap[];  /* 0x80000  spritemap (LE words) */
extern uint8_t cc_rom_motor[]; /* 0x08000  S.C.I. motor CPU ROM, stubbed */
...
extern uint8_t cc_rom_audio[];        /* 0x20000 audiocpu (cc_romdata.s) */
...
/* renderer API (cc_render.c) -- fills a 320x240 buffer of 12-bit palette PENS
