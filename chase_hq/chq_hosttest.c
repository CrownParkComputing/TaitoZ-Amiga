...
int main(int argc,char**argv){
    ...
    ld("../source/data/maincpu.bin",cc_rom_main,0x80000);
    ld("../source/data/sub.bin",cc_rom_sub,0x20000);
    ld("../source/data/gfx_scn.bin",cc_gfx_scn,0x80000);
    ld("../source/data/gfx_road.bin",cc_gfx_road,0x80000);
    ld("../source/data/sprites_asm.bin",cc_gfx_spr,0x200000);
    ld("../source/data/sprites2_asm.bin",cc_gfx_spr2,0x200000);
    ld("../source/data/spritemap_asm.bin",cc_gfx_smap,0x80000);
    ld("../source/data/motorcpu.bin",cc_rom_motor,0x8000);
    ld("../source/data/proms.bin",cc_proms,0x23000);
    ld("../source/data/cc_pal256.bin",cc_pal256,768);
    ld("../source/data/cc_lut32k.bin",cc_lut32k,32768);
    ld("../source/data/audiocpu.bin",cc_rom_audio,0x10000);
    ld("../source/data/adpcma.bin",cc_adpcma,0x180000);
    ld("../source/data/adpcmb.bin",cc_adpcmb,0x80000);
